...
WIDTH_FIX_MAIN=0
WIDTH_FIX_STATUS=0
DIR="$HOME/.config/rofi/qtile/configs"
...
function initialization() {
	...
	{ [[ -f "$HOME/.config/rofi/qtile/configs/style-1.rasi" ]] && RASI_DIR="$HOME/.config/rofi/qtile/configs/style-1.rasi"; } || { [[ -f "${XDG_CONFIG_HOME:-$HOME/.config}/rofi/rofi-network-manager.rasi" ]] && RASI_DIR="${XDG_CONFIG_HOME:-$HOME/.config}/rofi/launchers/type-4/style.rasi"; } || exit
