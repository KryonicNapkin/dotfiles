...
theme.taglist_bg_occupied = "#282c34"
theme.taglist_fg_occupied = "#ffffff"
theme.taglist_bg_empty = "#282c34"
theme.taglist_fg_empty = "#abb2bf"
theme.taglist_bg_volatile = "#282c34"
theme.taglist_fg_volatile = "#abb2bf"

theme.tasklist_icon_size = 0
theme.tasklist_disable_icon = false
theme.tasklist_bg_focus = "#61afef"
...
theme.icon_size = 8
theme.icon_size_temp = 8
theme.icon_size_disk = 8
theme.icon_color_ram = "#98c379"
theme.icon_color_disk = "#c678dd"
