...
function initialization() {
	...
	{ [[ -f "$HOME/.config/rofi.awesome/launchers/type-4/style-1.rasi" ]] && RASI_DIR="$HOME/.config/rofi.awesome/launchers/type-4/style-1.rasi"; } || { [[ -f "${XDG_CONFIG_HOME:-$HOME/.config}/rofi/rofi-network-manager.rasi" ]] && RASI_DIR="${XDG_CONFIG_HOME:-$HOME/.config}/rofi/launchers/type-4/style.rasi"; } || exit
